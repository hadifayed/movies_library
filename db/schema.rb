...
ActiveRecord::Schema[7.1].define(version: 2024_02_16_200938) do
  ...
  create_table "movie_actor_locations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["movie_id", "actor_id", "location_id"], name: "idx_on_movie_id_actor_id_location_id_eb8aee38d6", unique: true
